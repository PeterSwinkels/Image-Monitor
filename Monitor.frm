...
'Defines the variables used by this program.
Private Destination As String            'Contains the directory where the captured images are saved.
Private StopMonitor As Boolean           'Indicates whether the image monitor should stop.
Private TrayIconData As NOTIFYICONDATA   'Contains the system tray icon information.
...
Dim Index As Long
   ...
   If Destination = vbNullString Then Unload Me
